                            ...
                            {filteredProfiles.map((profile) => (
                                <tr key={profile.user_id} className="border-t border-slate-100">
                                    <td className="px-3 py-3">
                                        <Link href={{ pathname: `/users/${profile.user_id}` }} className="font-semibold text-slate-900">
                                            {profile.username}
                                        </Link>
                                    ...
                                    <td className="px-3 py-3">
                                        <Link href={{ pathname: `/users/${profile.user_id}` }} className="text-sm text-brand-primary">
                                            ดูรายละเอียด
                                        </Link>
                                    </td>
                                </tr>
