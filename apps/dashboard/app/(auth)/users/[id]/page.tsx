  ...
  if (!profile) {
    return (
      <Card className="text-center">
        ...
        <Link href={{ pathname: "/users" }} className="text-sm font-semibold text-brand-primary">
          กลับหน้ารายการ
        </Link>
      </Card>
    );
  ...
  return (
    <section className="space-y-6">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <Link href={{ pathname: "/users" }} className="text-sm text-brand-primary">
          กลับหน้ารายการ
        </Link>
      </div>
        ...
        <Card className="space-y-3">
          ...
          <dl className="space-y-2 text-sm text-slate-600">
            ...
            <div>
              ...
              <dd>
                <span
                  className={`inline-flex rounded-full px-3 py-1 text-xs font-semibold ${isActive ? 'bg-emerald-50 text-emerald-700' : 'bg-amber-50 text-amber-800'
                    }`}
                >
